...
export function registerListStaticRoutesTool(server: McpServer, client: OmadaClient): void {
    server.registerTool(
        ...
        {
            description:
                '[DEPRECATED] Use getGridStaticRouting instead. Same GET .../routing/static-routings endpoint. List static routing rules configured for a site: destination network, next-hop IP, interface, metric, and enabled state.',
