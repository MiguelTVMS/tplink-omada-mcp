...
import { registerGetGlobalThreatCountTool } from './getGlobalThreatCount.js';
import { registerGetGlobalTopThreatListTool } from './getGlobalTopThreatList.js';
...
import { registerGetPortForwardStatusTool } from './getPortForwardStatus.js';
...
export function registerAllTools(server: McpServer, client: OmadaClient): void {
    ...
    registerGetPortForwardStatusTool(server, client);
    registerGetGlobalTopThreatListTool(server, client);
    registerGetGlobalThreatCountTool(server, client);
