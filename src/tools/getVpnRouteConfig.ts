...
export function registerGetVpnRouteConfigTool(server: McpServer, client: OmadaClient): void {
    server.registerTool(
        ...
        {
            description:
                '[DEPRECATED] Use getGridPolicyRouting instead. Same GET .../routing/policy-routings endpoint. Get policy-based routing rules for a site, including source/destination matching criteria and next-hop gateway assignments.',
