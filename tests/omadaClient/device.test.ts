...
describe('omadaClient/device', () => {
    ...
    describe('getFirmwareUpgradePlan', () => {
        it('should return upgrade plan', async () => {
            ...
            expect(mockRequest.get).toHaveBeenCalledWith('/api/upgrade/plan', { page: 1, pageSize: 10 }, undefined);
            expect(result).toEqual({ data: [] });
        });
    });

    describe('getUpgradePlanList', () => {
        it('should return plan list', async () => {
            const resp = mockSimpleResponse({ data: [] });
            (mockRequest.get as ReturnType<typeof vi.fn>).mockResolvedValue(resp);
            await deviceOps.getUpgradePlanList(1, 10);
            expect(mockRequest.get).toHaveBeenCalledWith('/api/upgrade/list', { page: 1, pageSize: 10 }, undefined);
        });
    });
    ...
    describe('getUpgradeLogs', () => {
        it('should return upgrade logs', async () => {
            ...
            expect(mockRequest.get).toHaveBeenCalledWith('/api/upgrade/logs', { page: 1, pageSize: 10 }, undefined);
        });
    });

    describe('getGridBatchConfig', () => {
        it('should return batch config', async () => {
            const resp = mockSimpleResponse({ data: [] });
            (mockRequest.get as ReturnType<typeof vi.fn>).mockResolvedValue(resp);
            await deviceOps.getGridBatchConfig(1, 10);
            expect(mockRequest.get).toHaveBeenCalledWith('/api/batch-config', { page: 1, pageSize: 10 }, undefined);
        });
    });

    describe('getDevicePortConfig', () => {
        it('should return device port config', async () => {
            await testMacMethod('getDevicePortConfig', 'AA-BB', '/api/sites/site-1/devices/AA-BB/port-config', 'A deviceMac must be provided.');
        });
    });

    describe('getDeviceLldpNeighbors', () => {
        it('should return LLDP neighbors', async () => {
            await testMacMethod('getDeviceLldpNeighbors', 'AA-BB', '/api/sites/site-1/devices/AA-BB/lldp-neighbors', 'A deviceMac must be provided.');
        });
    });

    describe('getDevicePoEStatus', () => {
        it('should return PoE status', async () => {
            await testMacMethod('getDevicePoEStatus', 'AA-BB', '/api/sites/site-1/devices/AA-BB/poe-status', 'A deviceMac must be provided.');
        });
    });

    describe('getDevicePoEConfig', () => {
        it('should return PoE config', async () => {
            await testMacMethod('getDevicePoEConfig', 'AA-BB', '/api/sites/site-1/devices/AA-BB/poe-config', 'A deviceMac must be provided.');
        });
    });

    describe('getDeviceLedConfig', () => {
        it('should return LED config', async () => {
            await testMacMethod('getDeviceLedConfig', 'AA-BB', '/api/sites/site-1/devices/AA-BB/led', 'A deviceMac must be provided.');
        });
    });

    describe('getDevicePortMirror', () => {
        it('should return port mirror config', async () => {
            await testMacMethod('getDevicePortMirror', 'AA-BB', '/api/sites/site-1/devices/AA-BB/port-mirror', 'A deviceMac must be provided.');
        });
    });

    describe('getPortSchedule', () => {
        it('should return port schedule', async () => {
            await testMacMethod('getPortSchedule', 'AA-BB', '/api/sites/site-1/devices/AA-BB/port-schedule', 'A deviceMac must be provided.');
        });
    });

    describe('getDeviceStaticIp', () => {
        it('should return static IP config', async () => {
            await testMacMethod('getDeviceStaticIp', 'AA-BB', '/api/sites/site-1/devices/AA-BB/static-ip', 'A deviceMac must be provided.');
        });
    });

    describe('getDeviceIsolation', () => {
        it('should return isolation config', async () => {
            await testMacMethod('getDeviceIsolation', 'AA-BB', '/api/sites/site-1/devices/AA-BB/isolation', 'A deviceMac must be provided.');
        });
    });
    ...
    describe('getDeviceTagList', () => {
        it('should return tag list for site', async () => {
            ...
            expect(mockRequest.get).toHaveBeenCalledWith('/api/sites/site-1/devices/tags', undefined, undefined);
        });
    });

    describe('getDeviceCountByType', () => {
        it('should return device count by type', async () => {
            const resp = mockSimpleResponse({ ap: 5, sw: 3 });
            (mockRequest.get as ReturnType<typeof vi.fn>).mockResolvedValue(resp);
            await deviceOps.getDeviceCountByType('site-1');
            expect(mockRequest.get).toHaveBeenCalledWith('/api/sites/site-1/devices/count', undefined, undefined);
        });
    });

    describe('getDeviceHealthSummary', () => {
        it('should return health summary for site', async () => {
            const resp = mockSimpleResponse({ online: 8, offline: 1 });
            (mockRequest.get as ReturnType<typeof vi.fn>).mockResolvedValue(resp);
            await deviceOps.getDeviceHealthSummary('site-1');
            expect(mockRequest.get).toHaveBeenCalledWith('/api/sites/site-1/devices/health', undefined, undefined);
        });
    });

    describe('getDeviceOnlineStatus', () => {
        it('should return online status', async () => {
            await testMacMethod('getDeviceOnlineStatus', 'AA-BB', '/api/sites/site-1/devices/AA-BB/online-status', 'A deviceMac must be provided.');
        });
    });

    describe('getDeviceLocation', () => {
        it('should return device location', async () => {
            await testMacMethod('getDeviceLocation', 'AA-BB', '/api/sites/site-1/devices/AA-BB/location', 'A deviceMac must be provided.');
        });
    });

    describe('getDeviceLog', () => {
        it('should return device log', async () => {
            await testMacMethod('getDeviceLog', 'AA-BB', '/api/sites/site-1/devices/AA-BB/log', 'A deviceMac must be provided.');
        });
    });

    describe('getDeviceNeighborList', () => {
        it('should return neighbor list', async () => {
            await testMacMethod('getDeviceNeighborList', 'AA-BB', '/api/sites/site-1/devices/AA-BB/neighbors', 'A deviceMac must be provided.');
        });
    });

    describe('getDeviceUplinkHistory', () => {
        it('should return uplink history', async () => {
            await testMacMethod('getDeviceUplinkHistory', 'AA-BB', '/api/sites/site-1/devices/AA-BB/uplink-history', 'A deviceMac must be provided.');
        });
    });

    describe('getDeviceCpuMemStats', () => {
        it('should return CPU/mem stats', async () => {
            await testMacMethod('getDeviceCpuMemStats', 'AA-BB', '/api/sites/site-1/devices/AA-BB/cpu-mem-stats', 'A deviceMac must be provided.');
        });
    });

    describe('getDevicePortStats', () => {
        it('should return port stats', async () => {
            await testMacMethod('getDevicePortStats', 'AA-BB', '/api/sites/site-1/devices/AA-BB/port-stats', 'A deviceMac must be provided.');
        });
    });

    describe('getDevicePoePortStats', () => {
        it('should return PoE port stats', async () => {
            await testMacMethod('getDevicePoePortStats', 'AA-BB', '/api/sites/site-1/devices/AA-BB/poe-port-stats', 'A deviceMac must be provided.');
        });
    });

    describe('getDeviceStormControl', () => {
        it('should return storm control config', async () => {
            await testMacMethod('getDeviceStormControl', 'AA-BB', '/api/sites/site-1/devices/AA-BB/storm-control', 'A deviceMac must be provided.');
        });
    });

    describe('getDeviceVlanConfig', () => {
        it('should return VLAN config', async () => {
            await testMacMethod('getDeviceVlanConfig', 'AA-BB', '/api/sites/site-1/devices/AA-BB/vlan', 'A deviceMac must be provided.');
        });
    });

    describe('getDeviceStp', () => {
        it('should return STP config', async () => {
            await testMacMethod('getDeviceStp', 'AA-BB', '/api/sites/site-1/devices/AA-BB/stp', 'A deviceMac must be provided.');
        });
    });

    // AP methods
    describe('getApPoEConfig', () => {
        it('should return AP PoE config', async () => {
            await testMacMethod('getApPoEConfig', 'AA-BB', '/api/sites/site-1/aps/AA-BB/poe', 'An apMac must be provided.');
        });
    });

    describe('getApLedConfig', () => {
        it('should return AP LED config', async () => {
            await testMacMethod('getApLedConfig', 'AA-BB', '/api/sites/site-1/aps/AA-BB/led', 'An apMac must be provided.');
        });
    });

    describe('getApPortMirror', () => {
        it('should return AP port mirror config', async () => {
            await testMacMethod('getApPortMirror', 'AA-BB', '/api/sites/site-1/aps/AA-BB/port-mirror', 'An apMac must be provided.');
        });
    });

    describe('getApChannelConfig', () => {
        it('should return AP channel config', async () => {
            await testMacMethod('getApChannelConfig', 'AA-BB', '/api/sites/site-1/aps/AA-BB/channel', 'An apMac must be provided.');
        });
    });

    describe('getApBandSteeringConfig', () => {
        it('should return AP band steering config', async () => {
            await testMacMethod('getApBandSteeringConfig', 'AA-BB', '/api/sites/site-1/aps/AA-BB/band-steering', 'An apMac must be provided.');
        });
    });

    describe('getApBeaconConfig', () => {
        it('should return AP beacon config', async () => {
            await testMacMethod('getApBeaconConfig', 'AA-BB', '/api/sites/site-1/aps/AA-BB/beacon', 'An apMac must be provided.');
        });
    });

    describe('getApMeshConfig', () => {
        it('should return AP mesh config', async () => {
            await testMacMethod('getApMeshConfig', 'AA-BB', '/api/sites/site-1/aps/AA-BB/mesh-config', 'An apMac must be provided.');
        });
    });

    describe('getApRoamingConfig', () => {
        it('should return AP roaming config', async () => {
            await testMacMethod('getApRoamingConfig', 'AA-BB', '/api/sites/site-1/aps/AA-BB/roaming', 'An apMac must be provided.');
        });
    });

    describe('getApMacFilterConfig', () => {
        it('should return AP MAC filter config', async () => {
            await testMacMethod('getApMacFilterConfig', 'AA-BB', '/api/sites/site-1/aps/AA-BB/mac-filter', 'An apMac must be provided.');
        });
    });

    describe('getApDot1xConfig', () => {
        it('should return AP 802.1x config', async () => {
            await testMacMethod('getApDot1xConfig', 'AA-BB', '/api/sites/site-1/aps/AA-BB/dot1x', 'An apMac must be provided.');
        });
    });

    describe('getApPpskConfig', () => {
        it('should return AP PPSK config', async () => {
            await testMacMethod('getApPpskConfig', 'AA-BB', '/api/sites/site-1/aps/AA-BB/ppsk', 'An apMac must be provided.');
        });
    });

    describe('getApPortalConfig', () => {
        it('should return AP portal config', async () => {
            await testMacMethod('getApPortalConfig', 'AA-BB', '/api/sites/site-1/aps/AA-BB/portal', 'An apMac must be provided.');
        });
    });

    describe('getApScheduleConfig', () => {
        it('should return AP schedule config', async () => {
            await testMacMethod('getApScheduleConfig', 'AA-BB', '/api/sites/site-1/aps/AA-BB/schedule', 'An apMac must be provided.');
        });
    });

    describe('getApRateLimitConfig', () => {
        it('should return AP rate limit config', async () => {
            await testMacMethod('getApRateLimitConfig', 'AA-BB', '/api/sites/site-1/aps/AA-BB/rate-limit', 'An apMac must be provided.');
        });
    });
    ...
    describe('getApAclConfig', () => {
        it('should return AP ACL config', async () => {
            await testMacMethod('getApAclConfig', 'AA-BB', '/api/sites/site-1/aps/AA-BB/acl', 'An apMac must be provided.');
        });
    });

    describe('getApGroupConfig', () => {
        it('should return AP group config', async () => {
            await testMacMethod('getApGroupConfig', 'AA-BB', '/api/sites/site-1/aps/AA-BB/group', 'An apMac must be provided.');
        });
    });

    describe('getApMdnsConfig', () => {
        it('should return AP mDNS config', async () => {
            await testMacMethod('getApMdnsConfig', 'AA-BB', '/api/sites/site-1/aps/AA-BB/mdns', 'An apMac must be provided.');
        });
    });

    describe('getApIpv6Config', () => {
        it('should return AP IPv6 config', async () => {
            await testMacMethod('getApIpv6Config', 'AA-BB', '/api/sites/site-1/aps/AA-BB/ipv6', 'An apMac must be provided.');
        });
    });

    describe('getApStpConfig', () => {
        it('should return AP STP config', async () => {
            await testMacMethod('getApStpConfig', 'AA-BB', '/api/sites/site-1/aps/AA-BB/stp', 'An apMac must be provided.');
        });
    });

    describe('getApMulticastConfig', () => {
        it('should return AP multicast config', async () => {
            await testMacMethod('getApMulticastConfig', 'AA-BB', '/api/sites/site-1/aps/AA-BB/multicast', 'An apMac must be provided.');
        });
    });

    describe('getApWdsConfig', () => {
        it('should return AP WDS config', async () => {
            await testMacMethod('getApWdsConfig', 'AA-BB', '/api/sites/site-1/aps/AA-BB/wds', 'An apMac must be provided.');
        });
    });

    describe('getApUsageStats', () => {
        it('should return AP usage stats', async () => {
            await testMacMethod('getApUsageStats', 'AA-BB', '/api/sites/site-1/aps/AA-BB/usage-stats', 'An apMac must be provided.');
        });
    });

    describe('getApRoamHistory', () => {
        it('should return AP roam history', async () => {
            await testMacMethod('getApRoamHistory', 'AA-BB', '/api/sites/site-1/aps/AA-BB/roam-history', 'An apMac must be provided.');
        });
    });

    describe('getApAssocHistory', () => {
        it('should return AP association history', async () => {
            await testMacMethod('getApAssocHistory', 'AA-BB', '/api/sites/site-1/aps/AA-BB/assoc-history', 'An apMac must be provided.');
        });
    });

    describe('getApSignalHistory', () => {
        it('should return AP signal history', async () => {
            await testMacMethod('getApSignalHistory', 'AA-BB', '/api/sites/site-1/aps/AA-BB/signal-history', 'An apMac must be provided.');
        });
    });

    // Switch methods
    describe('getSwitchPoEConfig', () => {
        it('should return switch PoE config', async () => {
            await testMacMethod('getSwitchPoEConfig', 'AA-BB', '/api/sites/site-1/switches/AA-BB/poe', 'A switchMac must be provided.');
        });
    });

    describe('getSwitchPoEPortConfig', () => {
        it('should return switch PoE port config', async () => {
            await testMacMethod(
                'getSwitchPoEPortConfig',
                'AA-BB',
                '/api/sites/site-1/switches/AA-BB/poe-port-config',
                'A switchMac must be provided.'
            );
        });
    });

    describe('getSwitchStormControl', () => {
        it('should return switch storm control config', async () => {
            await testMacMethod('getSwitchStormControl', 'AA-BB', '/api/sites/site-1/switches/AA-BB/storm-control', 'A switchMac must be provided.');
        });
    });

    describe('getSwitchPortMirror', () => {
        it('should return switch port mirror config', async () => {
            await testMacMethod('getSwitchPortMirror', 'AA-BB', '/api/sites/site-1/switches/AA-BB/port-mirror', 'A switchMac must be provided.');
        });
    });

    describe('getLldpMedConfig', () => {
        it('should return LLDP-MED config', async () => {
            await testMacMethod('getLldpMedConfig', 'AA-BB', '/api/sites/site-1/switches/AA-BB/lldp-med', 'A switchMac must be provided.');
        });
    });

    describe('getSwitchSpanningTree', () => {
        it('should return STP config', async () => {
            await testMacMethod('getSwitchSpanningTree', 'AA-BB', '/api/sites/site-1/switches/AA-BB/stp', 'A switchMac must be provided.');
        });
    });

    describe('getSwitchMacTable', () => {
        it('should return MAC table', async () => {
            await testMacMethod('getSwitchMacTable', 'AA-BB', '/api/sites/site-1/switches/AA-BB/mac-table', 'A switchMac must be provided.');
        });
    });

    describe('getSwitchArpTable', () => {
        it('should return ARP table', async () => {
            await testMacMethod('getSwitchArpTable', 'AA-BB', '/api/sites/site-1/switches/AA-BB/arp-table', 'A switchMac must be provided.');
        });
    });

    describe('getSwitchVlanConfig', () => {
        it('should return VLAN config', async () => {
            await testMacMethod('getSwitchVlanConfig', 'AA-BB', '/api/sites/site-1/switches/AA-BB/vlan', 'A switchMac must be provided.');
        });
    });

    describe('getSwitchIpv6Config', () => {
        it('should return IPv6 config', async () => {
            await testMacMethod('getSwitchIpv6Config', 'AA-BB', '/api/sites/site-1/switches/AA-BB/ipv6', 'A switchMac must be provided.');
        });
    });

    describe('getSwitchQosPolicy', () => {
        it('should return QoS policy', async () => {
            await testMacMethod('getSwitchQosPolicy', 'AA-BB', '/api/sites/site-1/switches/AA-BB/qos', 'A switchMac must be provided.');
        });
    });

    describe('getSwitchAclConfig', () => {
        it('should return ACL config', async () => {
            await testMacMethod('getSwitchAclConfig', 'AA-BB', '/api/sites/site-1/switches/AA-BB/acl', 'A switchMac must be provided.');
        });
    });

    describe('getSwitchRateLimitConfig', () => {
        it('should return rate limit config', async () => {
            await testMacMethod('getSwitchRateLimitConfig', 'AA-BB', '/api/sites/site-1/switches/AA-BB/rate-limit', 'A switchMac must be provided.');
        });
    });

    describe('getSwitchDhcpSnooping', () => {
        it('should return DHCP snooping config', async () => {
            await testMacMethod('getSwitchDhcpSnooping', 'AA-BB', '/api/sites/site-1/switches/AA-BB/dhcp-snooping', 'A switchMac must be provided.');
        });
    });

    describe('getSwitchIpSourceGuard', () => {
        it('should return IP source guard config', async () => {
            await testMacMethod(
                'getSwitchIpSourceGuard',
                'AA-BB',
                '/api/sites/site-1/switches/AA-BB/ip-source-guard',
                'A switchMac must be provided.'
            );
        });
    });

    describe('getSwitchDynamicArpInspection', () => {
        it('should return dynamic ARP inspection config', async () => {
            await testMacMethod(
                'getSwitchDynamicArpInspection',
                'AA-BB',
                '/api/sites/site-1/switches/AA-BB/dynamic-arp-inspection',
                'A switchMac must be provided.'
            );
        });
    });
    ...
    // Gateway methods
    describe('getGatewayPoEConfig', () => {
        it('should return gateway PoE config', async () => {
            await testMacMethod('getGatewayPoEConfig', 'AA-BB', '/api/sites/site-1/gateways/AA-BB/poe', 'A gatewayMac must be provided.');
        });
    });

    describe('getGatewayPortConfig', () => {
        it('should return gateway port config', async () => {
            await testMacMethod('getGatewayPortConfig', 'AA-BB', '/api/sites/site-1/gateways/AA-BB/port-config', 'A gatewayMac must be provided.');
        });
    });

    describe('getGatewayWanPortDetail', () => {
        it('should return gateway WAN port detail', async () => {
            await testMacMethod(
                'getGatewayWanPortDetail',
                'AA-BB',
                '/api/sites/site-1/gateways/AA-BB/wan-port-detail',
                'A gatewayMac must be provided.'
            );
        });
    });

    describe('getGatewayUsageStats', () => {
        it('should return gateway usage stats', async () => {
            await testMacMethod('getGatewayUsageStats', 'AA-BB', '/api/sites/site-1/gateways/AA-BB/usage-stats', 'A gatewayMac must be provided.');
        });
    });

    describe('getGatewayArpTable', () => {
        it('should return gateway ARP table', async () => {
            await testMacMethod('getGatewayArpTable', 'AA-BB', '/api/sites/site-1/gateways/AA-BB/arp-table', 'A gatewayMac must be provided.');
        });
    });

    describe('getGatewayMacTable', () => {
        it('should return gateway MAC table', async () => {
            await testMacMethod('getGatewayMacTable', 'AA-BB', '/api/sites/site-1/gateways/AA-BB/mac-table', 'A gatewayMac must be provided.');
        });
    });

    describe('getGatewayIpv6Status', () => {
        it('should return gateway IPv6 status', async () => {
            await testMacMethod('getGatewayIpv6Status', 'AA-BB', '/api/sites/site-1/gateways/AA-BB/ipv6-status', 'A gatewayMac must be provided.');
        });
    });

    describe('getGatewayHaStatus', () => {
        it('should return gateway HA status', async () => {
            await testMacMethod('getGatewayHaStatus', 'AA-BB', '/api/sites/site-1/gateways/AA-BB/ha-status', 'A gatewayMac must be provided.');
        });
    });
});
